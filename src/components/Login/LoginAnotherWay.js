...
const otpErrMsg = "Please enter the valid OTP";
                    ...
                    <TextField
                      ...
                      helperText={
                        otpError ? (
                          ...
                          <span className="link-blue" onClick={sendOtpToEmail}>
                    ...
                    return (
                      <div key={key}>
                        ...
                        <TextField
                          required
                          error={errorFlag[key]}
                          helperText={errorFlag[key] ? requiredanswer : null}
                          id="filled-required"
                          variant="outlined"
                          size="small"
                          className="text-input"
                          name={"securityQestion" + (value + 1)}
                          placeholder="Answer"
                          onChange={handleStateChange}
                        />
                      </div>
