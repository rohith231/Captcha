                ...
                <TextField
                  ...
                  helperText={
                    otpError ? (
                      ...
                      <span className="resendotp-grayed" >Resend  one-time password({resendButtonDisabledTime})</span>
                    ) : (
                      <span className="link-blue" onClick={handleSubmit}>Resend  one-time password</span>
                    )
                  }
                />
              </div>
